...
public class Resident implements Comparable<Resident> {
    ...
    public boolean equals(Object other) {
        ...
        Resident o = (Resident) other;
        if ( this.surname1.equals(o.surname1) && this.surname2.equals(o.surname2) && this.name.equals(o.name)) ñaña = true;
        return ñaña;         
    ...
    public int compareTo(Resident other) {
        // TO BE COMPLETED
        int surname1Compared = this.getSurname1().compareTo(other.getSurname1());
        int surname2Compared = this.getSurname2().compareTo(other.getSurname2());
        int nameComparison = this.getName().compareTo(other.getName());
        int dniComparison = this.getDni().compareTo(other.getDni());
        
        if(surname1Compared != 0) {
        return surname1Compared;
        } else if(surname2Compared != 0) {
            return surname2Compared;
